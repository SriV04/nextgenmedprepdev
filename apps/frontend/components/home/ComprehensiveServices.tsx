  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Mock Interviews */}
        <div className="group bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all">
        ...
        {/* UCAT Services */}
        <div className="group bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all">
          <div className="mb-4 text-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        {/* Personal Statement */}
        <div className="group bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all">
          <div className="mb-4 text-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        <div className="group bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl p-6 shadow-md hover:shadow-xl transition-all">
          <div className="mb-4 text-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
