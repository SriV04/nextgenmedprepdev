...
const medicalSchools: MedicalSchool[] = [
  {
    ...
    location: 'Oxford',
    coordinates: [-1.2577, 51.7520], // [longitude, latitude]
                ...
                {medicalSchools.map((school) => (
                  <Marker key={school.id} coordinates={school.coordinates}>
                      <g>
                        ...
                        {/* Pin */}
                        <motion.circle
                          r={selectedSchool.id === school.id ? 8 : 6}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {selectedSchool.specialties.map((specialty, index) => (
                  <span
                    key={index}
          ...
          >
            <div className="bg-gradient-to-r from-purple-900/30 to-indigo-900/30 p-6 rounded-lg border border-purple-500/20 mb-6">
              ...
              <motion.button
                ...
                disabled
              >
                <div className="absolute inset-0 bg-gradient-to-r from-purple-600/20 to-indigo-600/20 opacity-0 hover:opacity-100 transition-opacity"></div>
