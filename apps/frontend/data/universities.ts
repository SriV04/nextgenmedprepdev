...
export const UK_MEDICAL_SCHOOLS: UKMedicalSchool[] = [
  ...
  },
  {
    ...
    interviewDate: 'December - March',
    decisionDate: 'March onwards',
    uniqueAspects: 'May be open to home applicants this year – website suggests not.',
    description: 'New medical school partnership.',
    establishedYear: 2023,
    specialties: ['Medicine'],
    admissionRequirements: 'AAA including Chemistry and Biology',
    ucatRequirement: 'Information not yet available',
  },
  {
    id: 'kent-medway',
    name: 'University of Kent and Medway',
    displayName: 'Kent and Medway',
