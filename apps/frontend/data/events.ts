...
export const upcomingEvent: UpcomingEvent = {
    id: "Dentistry_Interview_Conference_2026",
    title: "Everything You Need to Know About the Dentistry Interview",
    date: "2026-02-15",
    time: "10:00 AM - 11:00 AM",
    type: "interview" as const,
    description: "A 1-Hour Foundational Conference for Dental School Applicants 🦷",
    spots: 50,
    price: 15,
    details: "Master the core background knowledge and insight every applicant needs before walking into a dentistry interview. Learn what dental schools are truly assessing and how to demonstrate professional understanding.",
    benefits: [
        "🦷 Purpose of the Dentistry Interview",
        "🎓 What Dental Schools Are Looking For",
        "🏥 Understanding the Role of a Dentist",
        "⚖ Ethical Awareness in Dentistry",
        "👥 Communication & Professionalism",
        "🧠 Decision-Making & Professional Judgment",
        "🚫 Common Gaps in Applicant Knowledge"
    ],
    whatToExpect: [
        "✔ Clear understanding of interview structure",
        "✔ Foundational professional knowledge",
        "✔ Insight into dental educators' mindset",
        "✔ Greater confidence through understanding",
        "✔ Stronger professional identity"
    ],
    auxiliaryInfo: [
        "For dental school applicants preparing for MMI or panel interviews"
    ]
};
